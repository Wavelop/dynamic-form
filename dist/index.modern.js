...
const DynamicFormProvider = props => {
  ...
  return /*#__PURE__*/React.createElement(DynamicFormHelperContext.Provider, {
    ...
    value: dispatchModel
  }, /*#__PURE__*/React.createElement(DynamicFormErrorStateContext.Provider, {
    value: stateError
  ...
  return (config, {
    ...
    const value = config ? config.map((configObj, index) => {
      ...
      return /*#__PURE__*/React.createElement("span", {
        key: index * index + 1
      }, /*#__PURE__*/React.createElement(FactoryComponent, {
        debug: debug,
      ...
      }), debug && /*#__PURE__*/React.createElement(DebugFactoryComponent, {
...
function DebugDynamicForm() {
  ...
  const renderComponent = () => {
    ...
    return /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement("pre", {
      ...
      className: backgroundStyle
    }, /*#__PURE__*/React.createElement("span", null, "errorFromService"), JSON.stringify(errorFromService, undefined, 2)));
  };
...
function DebugFactoryComponent(props) {
  ...
  const renderComponent = () => {
    ...
    return /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement("pre", {
      className: backgroundStyle
    }, /*#__PURE__*/React.createElement("div", null, "DynamicForm"), /*#__PURE__*/React.createElement("div", null, "defaultValue: ", JSON.stringify(model || null, undefined, 2)), /*#__PURE__*/React.createElement("div", null, "Current value: ", JSON.stringify(state || {}, undefined, 2)), /*#__PURE__*/React.createElement("div", null, "Errors: ", JSON.stringify(error || [], undefined, 2))));
  };
...
function InputComponent(props) {
  ...
  const renderInput = () => {
    ...
    return /*#__PURE__*/React.createElement("section", null, inputLabel && /*#__PURE__*/React.createElement("label", {
      ...
      htmlFor: htmlFor
    }, inputLabel), /*#__PURE__*/React.createElement("input", attributes), error && showErrorOnInput && /*#__PURE__*/React.createElement("p", {
